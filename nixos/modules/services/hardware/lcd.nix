...
in
{
  ...
  imports = [
    ...
    (mkRenamedOptionModule [ "services" "hardware" "lcd" "usbPermissions" ] [ "services" "hardware" "lcd" "server" "usb" "permissions" ])
    (mkRenamedOptionModule [ "services" "hardware" "lcd" "usbVid" ] [ "services" "hardware" "lcd" "server" "usb" "vid" ])
    (mkRenamedOptionModule [ "services" "hardware" "lcd" "usbPid" ] [ "services" "hardware" "lcd" "server" "usb" "pid" ])
    (mkRenamedOptionModule [ "services" "hardware" "lcd" "usbGroup" ] [ "services" "hardware" "lcd" "server" "usb" "group" ])
  ];
